package com.github.geekcloud.framework.log.aspect;
...
import com.github.geekcloud.framework.log.util.LogUtil;
        ...
        tryCatch((aaa) -> {
            ...
            if (resultWrapper == null) {
                ...
                if (resultWrapper.isSuccess()) {
                    ...
                    sysLog.setType("EX");
                    sysLog.setExDetail(resultWrapper.getMessage());
                }
                if (sysLogAnno.response()) {
                    sysLog.setResult(getText(resultWrapper.toString()));
                }
            }
