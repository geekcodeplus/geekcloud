package com.github.geekcloud.framework.cache.config;

import com.github.geekcloud.framework.cache.lock.RedisDistributedLock;
import com.github.geekcloud.framework.cache.properties.CustomCacheProperties;
import com.github.geekcloud.framework.cache.repository.CacheRepository;
import com.github.geekcloud.framework.cache.repository.RedisRepositoryImpl;
import com.github.geekcloud.framework.cache.utils.RedisObjectSerializer;
import com.github.geekcloud.framework.core.lock.DistributedLock;
...
@ConditionalOnProperty(name = "geekcloud.cache.type", havingValue = "REDIS", matchIfMissing = true)
