...
import com.github.geekcloud.framework.cache.lock.CaffeineDistributedLock;
...
import com.github.geekcloud.framework.cache.repository.CaffeineRepositoryImpl;
...
/**
 * @ClassName: CaffeineAutoConfigure
 * @author: jeffrey
 * @date: 2020年04月28日
 * @Description: 内存缓存配置
 */
@Slf4j
@ConditionalOnProperty(name = "geekcloud.cache.type", havingValue = "CAFFEINE")
