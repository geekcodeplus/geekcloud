package com.github.geekcloud.framework.dozer;
...
import static com.github.geekcloud.framework.dozer.DozerProperties.PREFIX;

/**
 * @ClassName: DozerProperties
 * @author: jeffrey
 * @date: 2020年04月28日
 * @Description: Configuration properties for Dozer.
 */
@ConfigurationProperties(prefix = PREFIX)
public class DozerProperties {

    public static final String PREFIX = "dozer";
