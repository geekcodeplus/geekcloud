 ...
 *  * Swagger2 启动类
 *  * 启动条件：
 *  * 1，配置文件中 geekcloud.swagger.enabled=true
 *  * 2，配置文件中不存在：geekcloud.swagger.enabled 值
 */
@Configuration
...
public class Swagger2Configuration implements WebMvcConfigurer {
        ...
        public static class ZhSecurityConfiguration {
                ...
                @ConditionalOnProperty(name = "geekcloud.swagger.production", havingValue = "true")
                ...
                @Bean
                @ConditionalOnMissingBean
                @ConditionalOnProperty(name = "geekcloud.swagger.basic.enable", havingValue = "true")
                ...
                @ConditionalOnMissingBean
                @ConditionalOnProperty(name = "geekcloud.swagger.markdown.enable", havingValue = "true")
