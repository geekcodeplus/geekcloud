package com.github.geekcloud.security.client.service.impl;

import com.github.geekcloud.framework.core.response.ResultWrapper;
import com.github.geekcloud.security.client.provider.AuthProvider;
...
public class AuthService implements IAuthService {
    ...
    @Override
    public ResultWrapper authenticate(String authentication, String url, String method) {
    ...
    @Override
    public boolean hasPermission(ResultWrapper authResult) {
